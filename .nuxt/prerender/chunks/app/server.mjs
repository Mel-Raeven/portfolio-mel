import { version, hasInjectionContext, inject, getCurrentInstance, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, createTextVNode, nextTick, defineComponent, h, Suspense, Transition } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/h3/dist/index.mjs';
import { renderSSRHead } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/@unhead/ssr/dist/index.mjs';
import { composableNames, getActiveHead, createServerHead as createServerHead$1 } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1, RouterView } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/vue-router/dist/vue-router.node.mjs';
import { hasProtocol, parseURL, joinURL } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///home/schultenbrau/Repos/portfolio-mel/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f5a97629.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_project_-beb65def.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-4666d112.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-f5e66248.mjs').then((r) => r.default || r));
